...
namespace J2N.Globalization
{
    internal static partial class OrdinalCasing
    {
        ...
        private static ushort[] NoCasingPage => Arrays.Empty<ushort>();
...
// Here is an example of how we can call InitOrdinalCasingPage on .NET Core:
...
//    {
//        public const string GlobalizationNative = "System.Globalization.Native"; // Linux is "libSystem.Globalization.Native"; (I am guessing macOS is, too)
//        public const string ICU4C = "icuuc";  // Linux is "libicuuc.so", macOS is "libicuuc.dylib"
//    }

//    internal static partial class Globalization
//    {
//        // In .NET 8+, we can instead use
//        //[LibraryImport(Libraries.GlobalizationNative, EntryPoint = "GlobalizationNative_InitOrdinalCasingPage", StringMarshalling = StringMarshalling.Utf16)]
//        //internal static unsafe partial void InitOrdinalCasingPage(int pageNumber, char* pTarget);

//        [DllImport(Libraries.GlobalizationNative, EntryPoint = "GlobalizationNative_InitOrdinalCasingPage", CharSet = CharSet.Unicode)]
//        internal static unsafe extern void InitOrdinalCasingPage(int pageNumber, char* pTarget);

//        // P/Invoke declaration for getting the Unicode version
//        [DllImport(Libraries.ICU4C, EntryPoint = "u_getUnicodeVersion", CharSet = CharSet.Ansi)]
//        internal static extern void GetUnicodeVersion(byte[] versionArray);

//        // P/Invoke declaration for the ICU version
//        [DllImport(Libraries.ICU4C, EntryPoint = "u_getVersion", CharSet = CharSet.Ansi)]
//        internal static extern void GetIcuVersion(byte[] versionArray);
//    }
//}
...
//        private static ushort[][] s_casingTable = new ushort[256][];
//        static void Main(string[] args)
//        {
//            byte[] versionArray = new byte[4];
//            Interop.Globalization.GetUnicodeVersion(versionArray);

//            Console.WriteLine($"Unicode Version: {versionArray[0]}.{versionArray[1]}.{versionArray[2]}.{versionArray[3]}");

//            Interop.Globalization.GetIcuVersion(versionArray);

//            Console.WriteLine($"ICU Version: {versionArray[0]}.{versionArray[1]}.{versionArray[2]}.{versionArray[3]}");


//            Console.WriteLine("Initializing ordinal casing for page 2...");

//            ushort[] casingPage = InitOrdinalCasingPage(2);

//            Console.WriteLine("Ordinal casing page initialized.");
//            Console.WriteLine("First 32 values:");
//            for (int i = 0; i < 32; i++)
//            {
//                Console.Write($"{casingPage[i]} ");
//            }
