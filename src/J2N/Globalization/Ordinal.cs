// Source: https://github.com/dotnet/runtime/blob/v10.0.0-rc.2.25502.107/src/libraries/System.Private.CoreLib/src/System/Globalization/Ordinal.cs
...
namespace J2N.Globalization
{
    internal static partial class Ordinal
    {
        ...
        internal static bool EqualsIgnoreCase_Scalar(ref char charA, ref char charB, int length)
        {
            ...
            while ((uint)length >= 2) // J2N NOTE: This would be an if block on 64 bit, but this will just loop once in that case
            {
        ...
        internal static int IndexOfOrdinalIgnoreCase(ReadOnlySpan<char> source, ReadOnlySpan<char> value)
        {
            ...
            Span<char> letterBuffer = stackalloc char[2];
