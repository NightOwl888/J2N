...
{
    // J2N TODO: Ideally, we would use this info as source data for the Character class. This
    // should make it perform better and also keep the Unicode version in sync with the collection comparers
    // in the case of OrdinalIgnoreCase.
    ...
    internal static partial class CharUnicodeInfo
    {
        ...
        private static nuint GetCategoryCasingTableOffsetNoBoundsChecks(uint codePoint)
        {
            ...
            uint index = Unsafe.AddByteOffset(ref MemoryMarshal.GetReference(CategoryCasingLevel1Index), (IntPtr)(codePoint >> 9));
            ...
            ref byte level2Ref = ref Unsafe.AddByteOffset(ref MemoryMarshal.GetReference(CategoryCasingLevel2Index), (IntPtr)((index << 6) + ((codePoint >> 3) & 0b_0011_1110)));
            ...
            return Unsafe.AddByteOffset(ref MemoryMarshal.GetReference(CategoryCasingLevel3Index), (IntPtr)((index << 4) + (codePoint & 0x0F)));
        }
