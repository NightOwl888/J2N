...
namespace J2N.IO
{
    ...
    public abstract class Int16Buffer : Buffer, IComparable<Int16Buffer>
    {
        ...
        public Int16Buffer Put(short[] source) => InternalPut(source);

        internal virtual Int16Buffer InternalPut(short[] source) // J2N: Hack so we can use span by default without affecting calling order
        {
            if (source is null)
