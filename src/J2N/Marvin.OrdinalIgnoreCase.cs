// Source: https://github.com/dotnet/runtime/blob/v10.0.0-rc.2.25502.107/src/libraries/System.Private.CoreLib/src/System/Marvin.OrdinalIgnoreCase.cs
    ...
    internal static partial class Marvin
    {
        ...
        private static int ComputeHash32OrdinalIgnoreCaseSlow(ref char data, int count, uint p0, uint p1)
        {
            ...
            unsafe
            {
                fixed (char* ptr = &data)
                {
                    ReadOnlySpan<char> span = new ReadOnlySpan<char>(ptr, count);
                    charsWritten = Globalization.Ordinal.ToUpperOrdinal(span, scratch);
                }
            }
