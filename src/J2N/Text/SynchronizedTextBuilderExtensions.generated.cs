...
namespace J2N.Text
{
    internal static partial class SynchronizedTextBuilderExtensions
    {
        ...
        /// -or-
        /// <para/>
        /// <paramref name="index"/> is greater than <see cref="SynchronizedTextBuilder.Length"/>.
        /// </exception>
        ...
        /// at the specified index, expanding the <see cref="SynchronizedTextBuilder.Length"/> by
        /// <paramref name="count"/>.
        /// </summary>
        /// <typeparam name="TBuilder">The type of the target builder.</typeparam>
        /// <param name="text">The target builder.</param>
        ...
        /// than <see cref="SynchronizedTextBuilder.Length"/>.
        /// </exception>
        /// <exception cref="ArgumentException">
        ...
        /// -or-
        /// <para/>
        /// Appending <paramref name="repeatCount"/> * the length of the code point would result in a buffer size larger than <see cref="SynchronizedTextBuilder.MaxCapacity"/>.
        /// </exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
