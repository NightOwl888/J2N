...
namespace J2N.Text
{
    ...
    public sealed partial class PooledTextBuilder
    {
        ...
        /// the value of its <see cref="PooledTextBuilder.MaxCapacity"/> property. This can occur particularly when you call the <see cref="PooledTextBuilderExtensions.Append{TBuilder}(TBuilder, string?)"/>
        /// and <see cref="PooledTextBuilderExtensions.AppendFormat{TBuilder}(TBuilder, string, object?)"/> methods to append small strings.
        /// </remarks>
        ...
        /// after calling the <see cref="PooledTextBuilderExtensions.Clear{TBuilder}(TBuilder)"/> method or setting <see cref="Length"/> property to 0.
        /// <para/>
        ...
        /// When you instantiate a <see cref="PooledTextBuilder"/> object by calling <see cref="PooledTextBuilder(int, int)"/>,
        /// both the length and the capacity of the <see cref="PooledTextBuilder"/> instance can grow beyond
        /// the value of its <see cref="MaxCapacity"/> property. This can occur particularly when you call the <see cref="PooledTextBuilderExtensions.Append{TBuilder}(TBuilder, string?)"/>
        /// and <see cref="PooledTextBuilderExtensions.AppendFormat{TBuilder}(TBuilder, string, object?)"/> methods to append small strings.
        /// </remarks>
