...
namespace J2N.Text
{
    ...
    public sealed partial class PooledTextBuilder
    {
        ...
        /// later implementations. You can explicitly set the maximum capacity of a <see cref="PooledTextBuilder"/>
        ...
        /// you may call the <see cref="TextMemoryExtensions.AsSpan(PooledTextBuilder)"/> method
        ...
        /// 
        /// This method causes a heap allocation. As an allocation-free alternative,
        /// you may call the <see cref="TextMemoryExtensions.AsSpan(PooledTextBuilder, int)"/> method
        ...
        /// 
        /// This method causes a heap allocation. As an allocation-free alternative,
        /// you may call the <see cref="TextMemoryExtensions.AsSpan(PooledTextBuilder, int, int)"/> method
        /// to get a <see cref="ReadOnlySpan{T}"/> representing the characters of the substring of this
        /// <see cref="PooledTextBuilder"/> instance.
        /// <para/>
        /// Call the <see cref="ToString(int)"/> method to convert the
        ...
        /// reference and you do not have to assign the return value to an <see cref="PooledTextBuilder"/> object,
        ...
        /// to an <see cref="PooledTextBuilder"/> object, as the following example illustrates.
        /// <code>
        /// bool flag = false;
        /// J2N.Text.PooledTextBuilder sb = new J2N.Text.PooledTextBuilder();
        ...
        /// it does not return a new class instance. Because of this, you can call a method or
        /// property on the existing reference and you do not have to assign the return value
        /// to an <see cref="PooledTextBuilder"/> object.
        /// <para/>
        /// If <paramref name="value"/> is <c>null</c>, no changes are made.
        /// <para/>
        /// The capacity of this instance is adjusted as needed.
        ...
        /// <see cref="this[int]"/>, <see cref="TextMemoryExtensions.AsSpan(PooledTextBuilder, int, int)"/> or <see cref="CopyTo(int, Span{char}, int)"/>.
        /// 
        /// </remarks>
        ...
        /// <see cref="this[int]"/> or <see cref="TextMemoryExtensions.AsSpan(PooledTextBuilder, int, int)"/>.
        /// 
        /// </remarks>
        ...
        /// 
        /// </remarks>
        public PooledTextBuilder Insert(int index, string? value, int count)
        {
        ...
        /// 
        /// </remarks>
        public PooledTextBuilder Insert(int index, ReadOnlySpan<char> value, int count)
        {
            buffer.Insert(index, value, count);
            return this;
        }
        ...
        /// is never reversed.
        /// <para/>
        /// IMPORTANT: This operation is done in-place. Although an <see cref="PooledTextBuilder"/>
        ...
        /// 
        /// </remarks>
        public PooledTextBuilder DuplicateRange(Range range, int destinationIndex)
        {
        ...
        /// 
        /// </remarks>
        public PooledTextBuilder DuplicateRange(int startIndex, int count, int destinationIndex)
        {
