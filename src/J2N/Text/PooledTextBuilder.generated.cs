...
namespace J2N.Text
{
    ...
    public sealed partial class PooledTextBuilder
    {
        ...
        /// Its value can range from <see cref="Length"/> to <see cref="PooledTextBuilder.MaxCapacity"/>.
        /// </value>
        ...
        /// object by calling <see cref="PooledTextBuilder(int, int)"/>.
        /// <para/>
        ...
        /// the string stored to the <see cref="PooledTextBuilder"/> object.
        /// <para/>
        /// If the specified length is less than the current length, the current <see cref="PooledTextBuilder"/>
        /// object is truncated to the specified length. If the specified length is greater than the current
        /// length, the end of the string value of the current <see cref="PooledTextBuilder"/> object is padded
        ...
        /// <para/>
        /// <see cref="this[int]"/> is the default property of the <see cref="PooledTextBuilder"/>  class.
        ...
        ///         int nWhitespace = 0;
        ///         int nPunctuation = 0;
        ///         PooledTextBuilder sb = new PooledTextBuilder("This is a simple sentence.");
        /// 
        ...
        /// <see cref="PooledTextBuilder"/> instance.
        /// <para/>
        ...
        /// </remarks>
        public PooledTextBuilder Clear()
        {
            buffer.Clear();
            return this;
        }
        ...
        /// <para/>
        /// The <see cref="PooledTextBuilder.Append(char[], int, int)"/> method modifies the existing instance of this class; it does
        ...
        /// <exception cref="ArgumentOutOfRangeException">Enlarging the value of this instance would exceed <see cref="PooledTextBuilder.MaxCapacity"/>.</exception>
        /// <remarks>
        /// The <see cref="PooledTextBuilder.Append(string?)"/> method modifies the existing instance of this class;
        ...
        /// call the <see cref="PooledTextBuilder.Append(string?)"/> and <see cref="PooledTextBuilder.AppendFormat(string, object?)"/>
        ...
        /// <exception cref="ArgumentOutOfRangeException">Enlarging the value of this instance would exceed <see cref="PooledTextBuilder.MaxCapacity"/>.</exception>
        /// <remarks>
        /// The <see cref="PooledTextBuilder.Append(StringBuilder?)"/> method modifies the existing instance of this class;
        /// it does not return a new class instance. Because of this, you can call a method or
        /// property on the existing reference and you do not have to assign the return value
        ...
        /// are both zero, no changes are made.
        /// <para/>
        /// The <see cref="PooledTextBuilder.Append(StringBuilder?, int, int)"/> method modifies the existing instance of this class; it does
        /// not return a new class instance. Because of this, you can call a method or property on the existing
        /// reference and you do not have to assign the return value to a <see cref="PooledTextBuilder"/> object,
        /// as the following example illustrates.
        /// <code>
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// <para/>
        /// The <see cref="PooledTextBuilder.Append(char[])"/> method modifies the existing instance of this class; it does not
...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        /// <para/>
        /// The <see cref="PooledTextBuilder.Append(char*, int)"/> method modifies the existing instance of this class; it does
        /// not return a new class instance. Because of this, you can call a method or property on the existing
        /// reference and you do not have to assign the return value to a <see cref="PooledTextBuilder"/> object.
        /// <para/>
        /// The capacity of this instance is adjusted as needed.
        ...
        /// to <c><see cref="Length"/> - <paramref name="startIndex"/>.</c>, provided it is not bounded by <see cref="PooledTextBuilder.MaxCapacity"/>.
        /// </summary>
        ...
        /// execution of the <see cref="PooledTextBuilder.Reverse()"/> method. Then the
        ...
        /// <summary>
        /// Sets the capacity of a <see cref="PooledTextBuilder"/> object to the actual number of characters
        /// it contains.
        /// </summary>
        /// <remarks>
        /// This method is similar to <c>trimToSize()</c> in the JDK.
        /// <para/>
        /// You can use the <see cref="TrimExcess()"/> method to minimize a <see cref="PooledTextBuilder"/> object's
        /// memory overhead once it is known that no new characters will be added. To completely clear an
        /// <see cref="PooledTextBuilder"/> object and release all memory referenced by it, call this method
        ...
        /// -or-
        /// <para/>
        /// <paramref name="length"/> plus the current length of this instance exceeds <see cref="PooledTextBuilder.MaxCapacity"/>.
        /// </exception>
        /// <remarks>
