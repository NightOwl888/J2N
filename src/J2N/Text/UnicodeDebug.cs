// Source: https://github.com/dotnet/runtime/blob/v10.0.0-rc.2.25502.107/src/libraries/System.Private.CoreLib/src/System/Text/UnicodeDebug.cs
...
namespace J2N.Text
{
    internal static class UnicodeDebug
    {
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "U+{0:X4}", codePoint);
        }
    }
}
