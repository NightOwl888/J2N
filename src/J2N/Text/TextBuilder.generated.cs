...
namespace J2N.Text
{
    ...
    public partial class TextBuilder
    {
        ...
        /// <see cref="TextBuilder"/>. This can be used for more complex and low-level business
        ...
        /// <para/>
        /// The <see cref="TrimExcess()"/> method can be used to minimize a <see cref="TextBuilder"/> object's
        /// memory overhead once it is known that no new characters will be added.
        /// <para/>
        /// To completely clear a <see cref="TextBuilder"/> object and release all memory referenced by it,
        /// call <see cref="TrimExcess()"/> after calling the <see cref="TextBuilderExtensions.Clear{TBuilder}(TBuilder)"/>
        ...
        /// <see cref="this[int]"/>, <see cref="TextBuilderExtensions.AsSpan(TextBuilder?, int, int)"/> or
