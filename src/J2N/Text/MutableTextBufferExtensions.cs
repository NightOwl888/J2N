...
namespace J2N.Text
{
    ...
    internal static partial class MutableTextBufferExtensions
    {
        ...
        /// <summary>
        /// Creates a new <see cref="ReadOnlyMemory{T}"/> over the portion of the target <paramref name="text"/>.
        /// </summary>
        /// <param name="text">The target <paramref name="text"/>.</param>
        /// <returns>The read-only character memory representation of the <paramref name="text"/>, or <c>default</c> if
        ...
        /// <returns>The read-only character memory representation of the <paramref name="text"/>, or <c>default</c>
        ...
        /// <summary>
        /// Creates a new readonly span over the portion of the target <paramref name="text"/>.
        /// </summary>
        /// <param name="text">The target <paramref name="text"/>.</param>
