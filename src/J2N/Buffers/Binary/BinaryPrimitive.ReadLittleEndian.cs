// Based on: https://github.com/dotnet/runtime/blob/v9.0.3/src/libraries/System.Private.CoreLib/src/System/Buffers/Binary/BinaryPrimitives.ReadLittleEndian.cs
    ...
    public static partial class BinaryPrimitive
    {
        ...
        public static double ReadDoubleLittleEndian(ReadOnlySpan<byte> source)
        {
            return !BitConverter.IsLittleEndian ?
                BitConversion.Int64BitsToDouble(ReverseEndianness(MemoryMarshal.Read<long>(source))) : // J2N TODO: Change to use double ReverseEndianness? Should it be conditional based on whether [Intrinsic] is supported?
...
//#endif
        ...
        {
            return !BitConverter.IsLittleEndian ?
                BitConversion.Int32BitsToSingle(ReverseEndianness(MemoryMarshal.Read<int>(source))) : // J2N TODO: Change to use float ReverseEndianness? Should it be conditional based on whether [Intrinsic] is supported?
...
//#endif
        ...
        public static bool TryReadDoubleLittleEndian(ReadOnlySpan<byte> source, out double value)
        {
            if (!BitConverter.IsLittleEndian)
            {
                ...
                value = BitConversion.Int64BitsToDouble(ReverseEndianness(tmp)); // J2N TODO: Change to use double ReverseEndianness? Should it be conditional based on whether [Intrinsic] is supported?
                return success;
            }
        ...
        public static bool TryReadSingleLittleEndian(ReadOnlySpan<byte> source, out float value)
        {
            ...
            {
                bool success = MemoryMarshal.TryRead(source, out int tmp);
                value = BitConversion.Int32BitsToSingle(ReverseEndianness(tmp)); // J2N TODO: Change to use float ReverseEndianness? Should it be conditional based on whether [Intrinsic] is supported?
                return success;
            }
