// Source: https://github.com/dotnet/runtime/blob/v9.0.3/src/libraries/System.Private.CoreLib/src/System/Buffers/Binary/BinaryPrimitives.WriteBigEndian.cs
...
namespace J2N.Buffers.Binary
{
    public static partial class BinaryPrimitive
    {
        ...
        public static void WriteDoubleBigEndian(Span<byte> destination, double value)
        {
            ...
            {
                long tmp = ReverseEndianness(BitConversion.DoubleToRawInt64Bits(value));
        ...
        //    if (BitConverter.IsLittleEndian)
        //    {
        //        short tmp = ReverseEndianness(BitConversion.HalfToInt16Bits(value));
        //        MemoryMarshal.Write(destination, ref tmp);
        //    }
        //    else
        //    {
...
//#endif
        ...
        public static void WriteSingleBigEndian(Span<byte> destination, float value)
        {
            if (BitConverter.IsLittleEndian)
            {
                int tmp = ReverseEndianness(BitConversion.SingleToRawInt32Bits(value));
                MemoryMarshal.Write(destination, ref tmp);
            }
            else
            {
