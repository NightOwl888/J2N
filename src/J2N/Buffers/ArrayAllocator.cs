...
{
    /// <summary>
    /// A simple allocator that provides newly cleared arrays.
    /// </summary>
    ...
    internal sealed class ArrayAllocator<T> : IArrayAllocator<T>
    {
        ...
        /// <summary>
        /// Gets the default instance of <see cref="ArrayAllocator{T}"/>.
        /// </summary>
        public static ArrayAllocator<T> Default { get; } = new();
