...
{
    /// <summary>
    /// A class that is used to store packed <see cref="int"/> values.
    ...
    /// This instance will be allocated on the heap, so it can be used across method calls.
    /// </summary>
    internal class Int32Packer // KEEP IN SYNC WITH ValueInt32Packer
    {
