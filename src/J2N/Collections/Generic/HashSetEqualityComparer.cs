// https://github.com/dotnet/runtime/blob/v9.0.9/src/libraries/System.Private.CoreLib/src/System/Collections/Generic/HashSetEqualityComparer.cs
...
namespace J2N.Collections.Generic
{
    ...
    internal sealed class HashSetEqualityComparer<T> : IEqualityComparer<HashSet<T>?>
    {
        public bool Equals(HashSet<T>? x, HashSet<T>? y)
        {
            ...
            {
                return x.Count == y.Count && y.IsSubsetOfHashSetWithSameEC(x);
            }
