...
namespace J2N.Numerics
{
    ...
    /// <summary>
    /// An immutable reference type that wraps the primitive <see cref="sbyte"/> type.
    /// <para/>
    /// In addition, this class provides methods for converting a <see cref="sbyte"/> to a <see cref="string"/> and
    /// a <see cref="string"/> to a <see cref="sbyte"/> that are compatible with Java.
    /// <para/>
    /// Instances of this class can be produced implicitly by setting a <see cref="sbyte"/> value to a variable declared
    /// as <see cref="SByte"/>
    /// <code>
    /// sbyte value = 4;
    /// SByte instance = value;
    /// </code>
    /// Or explicitly by calling one of the <see cref="GetInstance(sbyte)"/>, <see cref="Decode(string)"/>,
    /// or <see cref="TryDecode(string, out SByte)"/> methods.
    /// <para/>
    /// The <see cref="sbyte"/> value of a <see cref="SByte"/> can also be retrieved in several ways. For implicit
    /// conversion, simply assign a <see cref="sbyte"/> variable an instance of <see cref="SByte"/>.
    /// <code>
    /// SByte instance = SByte.GetInstance((sbyte)4);
    /// sbyte value = instance;
    /// </code>
    /// To explicitly get the value, call <see cref="ToSByte()"/> or use the <see cref="Convert"/> class.
    /// <code>
    ...
    public sealed class SByte : Number, IComparable<SByte>, IComparable, IConvertible, IEquatable<SByte>
    {
        ...
        /// <summary>
        /// A cache of instances used by <see cref="GetInstance(sbyte)"/> and auto-boxing.
        /// </summary>
        private static readonly SByte[] Cache = new SByte[256];

        /// <summary>
        /// Initializes a new instance of the <see cref="SByte"/> class.
        /// </summary>
        /// <param name="value">The primitive <see cref="sbyte"/> value to store in the new instance.</param>
        internal SByte(sbyte value) // J2N: This has been marked deprecated in JDK 16, so we are marking it internal
        {
            this.value = value;
        }
        ...
        /// <summary>
        /// Compares this instance to a specified <see cref="SByte"/> and returns an indication of their relative values.
        /// </summary>
        /// <param name="value">An <see cref="SByte"/> to compare, or <c>null</c>.</param>
        /// <returns>
        ...
        /// </list>
        /// </returns>
        /// <exception cref="ArgumentException"><paramref name="value"/> is not a <see cref="SByte"/>.</exception>
        /// <remarks>
        /// <paramref name="value"/> must be <c>null</c> or an instance of <see cref="SByte"/>; otherwise, an exception is thrown.
        /// <para/>
        /// Any instance of <see cref="SByte"/>, regardless of its value, is considered greater than <c>null</c>.
        /// <para/>
        ...
        /// <summary>
        /// Decodes a <see cref="string"/> into an <see cref="SByte"/>. Accepts decimal, hexadecimal, and octal numbers given by the following grammar:
        /// <list type="bullet">
        ///     <item>
        ...
        /// <see cref="sbyte.MaxValue"/>. This parameter is passed uninitialized; any value originally supplied in result will be overwritten.</param>
        /// <returns><c>true</c> if <paramref name="s"/> was converted successfully; otherwise, <c>false</c>.</returns>
        public static bool TryDecode(string s, [MaybeNullWhen(false)] out SByte result)
        {
            result = default;
        ...
        /// </summary>
        /// <param name="obj">A <see cref="SByte"/> value to compare to this instance.</param>
        ...
        /// <returns><c>true</c> if <paramref name="obj"/> is an instance of <see cref="SByte"/> and equals the value of
        /// this instance; otherwise, <c>false</c>.</returns>
        public override bool Equals(object? obj)
        {
            if (obj is null) return false;

            return ReferenceEquals(obj, this) || (obj is SByte other) && (value == other.value);
        }
        ...
        /// <returns>The <see cref="sbyte"/> represented by the subsequence in the specified <paramref name="radix"/>.</returns>
        /// <remarks>
        ...
        /// <exception cref="OverflowException">
        /// The range of characters in <paramref name="s"/> specified by <paramref name="startIndex"/> and <paramref name="length"/>
        /// represents a number that is less than <see cref="sbyte.MinValue"/> or greater than <see cref="sbyte.MaxValue"/>.
        /// </exception>
        /// <seealso cref="TryParse(ReadOnlySpan{char}, int, int, int, out sbyte)"/>
        ...
        /// represents a number that is less than <see cref="sbyte.MinValue"/> or greater than <see cref="sbyte.MaxValue"/>.
        /// </exception>
        /// <seealso cref="TryParse(string, int, int, int, out sbyte)"/>
        /// <seealso cref="Parse(string?, int)"/>
        ...
        /// Supports any BMP (Basic Multilingual Plane) or SMP (Supplementary Mulitlingual Plane) digit as defined by Unicode 10.0.
        /// </summary>
        /// <param name="s">The <see cref="T:char[]"/> containing the <see cref="sbyte"/> representation to be parsed.</param>
        /// <param name="startIndex">The zero-based starting character position of a region in <paramref name="s"/>.</param>
        /// <param name="length">The number of characters in the region to parse.</param>
        /// <param name="radix">The radix (or base) to use when parsing <paramref name="s"/>. The value must be in the range
        /// <see cref="Character.MinRadix"/> - <see cref="Character.MaxRadix"/> inclusive.</param>
        ...
        /// represents a number that is less than <see cref="sbyte.MinValue"/> or greater than <see cref="sbyte.MaxValue"/>.
        /// </exception>
        /// <seealso cref="TryParse(char[], int, int, int, out sbyte)"/>
        /// <seealso cref="Parse(string?, int)"/>
        ...
        /// Supports any BMP (Basic Multilingual Plane) or SMP (Supplementary Mulitlingual Plane) digit as defined by Unicode 10.0.
        /// </summary>
        /// <param name="s">The <see cref="StringBuilder"/> containing the <see cref="sbyte"/> representation to be parsed.</param>
        /// <param name="startIndex">The zero-based starting character position of a region in <paramref name="s"/>.</param>
        /// <param name="length">The number of characters in the region to parse.</param>
        /// <param name="radix">The radix (or base) to use when parsing <paramref name="s"/>. The value must be in the range
        /// <see cref="Character.MinRadix"/> - <see cref="Character.MaxRadix"/> inclusive.</param>
        ...
        /// represents a number that is less than <see cref="sbyte.MinValue"/> or greater than <see cref="sbyte.MaxValue"/>.
        /// </exception>
        /// <seealso cref="TryParse(StringBuilder, int, int, int, out sbyte)"/>
        /// <seealso cref="Parse(string?, int)"/>
        ...
        /// Supports any BMP (Basic Multilingual Plane) or SMP (Supplementary Mulitlingual Plane) digit as defined by Unicode 10.0.
        /// </summary>
        /// <param name="s">The <see cref="ICharSequence"/> containing the <see cref="sbyte"/> representation to be parsed.</param>
        /// <param name="startIndex">The zero-based starting character position of a region in <paramref name="s"/>.</param>
        /// <param name="length">The number of characters in the region to parse.</param>
        /// <param name="radix">The radix (or base) to use when parsing <paramref name="s"/>. The value must be in the range
        /// <see cref="Character.MinRadix"/> - <see cref="Character.MaxRadix"/> inclusive.</param>
        ...
        /// represents a number that is less than <see cref="sbyte.MinValue"/> or greater than <see cref="sbyte.MaxValue"/>.
        /// </exception>
        /// <seealso cref="TryParse(ICharSequence, int, int, int, out sbyte)"/>
        /// <seealso cref="Parse(string?, int)"/>
        ...
        /// </summary>
        /// <param name="s">The <see cref="ReadOnlySpan{Char}"/> containing the <see cref="sbyte"/> representation to be parsed.</param>
        /// <param name="startIndex">The zero-based starting character position of a region in <paramref name="s"/>.</param>
        /// <param name="length">The number of characters in the region to parse.</param>
        /// <param name="radix">The radix (or base) to use when parsing <paramref name="s"/>. The value must be in the range
        /// <see cref="Character.MinRadix"/> - <see cref="Character.MaxRadix"/> inclusive.</param>
        ...
        /// <seealso cref="Parse(string?, int)"/>
        public static bool TryParse(ReadOnlySpan<char> s, int startIndex, int length, int radix, out sbyte result) // KEEP OVERLOADS FOR ICharSequence, char[], ReadOnlySpan<char>, StringBuilder, and string IN SYNC
        {
            result = default;
        ...
        /// <seealso cref="Parse(string?, int)"/>
        public static bool TryParse(string s, int startIndex, int length, int radix, out sbyte result) // KEEP OVERLOADS FOR ICharSequence, char[], ReadOnlySpan<char>, StringBuilder, and string IN SYNC
        {
            result = default;
        ...
        /// <seealso cref="Parse(string?, int)"/>
        public static bool TryParse(char[] s, int startIndex, int length, int radix, out sbyte result) // KEEP OVERLOADS FOR ICharSequence, char[], ReadOnlySpan<char>, StringBuilder, and string IN SYNC
        {
            result = default;
        ...
        /// <seealso cref="Parse(string?, int)"/>
        public static bool TryParse(StringBuilder s, int startIndex, int length, int radix, out sbyte result) // KEEP OVERLOADS FOR ICharSequence, char[], ReadOnlySpan<char>, StringBuilder, and string IN SYNC
        {
            result = default;
        ...
        /// <seealso cref="Parse(string?, int)"/>
        public static bool TryParse(ICharSequence s, int startIndex, int length, int radix, out sbyte result) // KEEP OVERLOADS FOR ICharSequence, char[], ReadOnlySpan<char>, StringBuilder, and string IN SYNC
        {
            result = default;
        ...
        /// <paramref name="s"/> represents a number that is less than <see cref="sbyte.MinValue"/> or greater than <see cref="sbyte.MaxValue"/>.
        /// </exception>
        /// <seealso cref="TryParse(string?, int, out sbyte)"/>
        /// <seealso cref="Parse(string?, int)"/>
        public static sbyte Parse(string? s, int radix) // J2N: Renamed from ParseByte()
        {
            if (s == null)
            {
                return 0;
        ...
        /// <seealso cref="Parse(string, int, int, int)"/>
        /// <seealso cref="Parse(string?, int)"/>
        public static bool TryParse(string? s, int radix, out sbyte result) // J2N: Renamed from ParseByte()
        {
            if (radix < Character.MinRadix || radix > Character.MaxRadix)
                throw new ArgumentOutOfRangeException(nameof(radix), SR.ArgumentOutOfRange_Radix);
        ...
        #endregion TryParse_CharSequence_Int32_SByte
        ...
        /// <summary>
        /// Converts the string representation of a number in a specified style and culture-specific format to its <see cref="sbyte"/> equivalent.
        /// </summary>
        /// <param name="s">A string containing the characters representing the value to convert.
        /// The string is interpreted using the <see cref="NumberStyle.Integer"/> style.</param>
        ...
        /// <exception cref="OverflowException">
        /// <paramref name="s"/> represents a number less than <see cref="sbyte.MinValue"/> or <see cref="sbyte.MaxValue"/>.
        /// </exception>
        /// <remarks>
        ...
        /// <para/>
        /// The <paramref name="s"/> parameter is interpreted using the <see cref="NumberStyle.Integer"/> style. In addition to the sbyte value's
        ...
        public static sbyte Parse(string s, IFormatProvider? provider) // J2N: Renamed from ParseByte()
        {
        ...
        #region TryParse_CharSequence_SByte
        ...
        /// culture in the Byte class, so call <see cref="TryParse(string?, NumberStyle, IFormatProvider?, out sbyte)"/>
        ...
        /// but Java only ever throws NumberFormatException in any of those cases. Using <see cref="TryParse(string?, NumberStyle, IFormatProvider?, out sbyte)"/>
        ...
        /// or represents a number less than <see cref="sbyte.MinValue"/> or greater than <see cref="sbyte.MaxValue"/>. This parameter
        /// is passed uninitialized; any value originally supplied in <paramref name="result"/> will be overwritten.</param>
        /// <returns><c>true</c> if <paramref name="s"/> was converted successfully; otherwise, <c>false</c>.</returns>
        /// <remarks>
        /// The <see cref="TryParse(string?, out sbyte)"/> method is like the <see cref="Parse(string?, NumberStyle, IFormatProvider?)"/> method,
        /// except the <see cref="TryParse(string?, out sbyte)"/> method does not throw an exception if the
        ...
        /// information that can be present in <paramref name="s"/>, use the <see cref="TryParse(string?, NumberStyle, IFormatProvider?, out sbyte)"/> method.
        /// <para/>
        ...
        /// <para/>
        /// This overload of the <see cref="TryParse(string?, out sbyte)"/> method interprets all digits in the <paramref name="s"/> parameter
        /// as decimal digits. To parse the string representation of a hexadecimal number, call the
        /// <see cref="TryParse(string?, NumberStyle, IFormatProvider?, out sbyte)"/> overload.
        /// </remarks>
        ...
        /// <para/>
        /// Usage Note: When porting from Java, note that this is a culture-sensitive method. Java uses the invariant
        /// culture in the Byte class, so call <see cref="TryParse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?, out sbyte)"/>
        /// and pass <see cref="NumberStyle.AllowLeadingSign"/> and <see cref="NumberFormatInfo.InvariantInfo"/> to exactly match the Java parsing behavior.
        /// <para/>
        /// Using that overload also allows you to normalize the exception behavior. The <see cref="Parse(string, IFormatProvider?)"/>
        /// method may throw <see cref="ArgumentNullException"/>, <see cref="OverflowException"/>, or <see cref="FormatException"/>,
        /// but Java only ever throws NumberFormatException in any of those cases. Using <see cref="TryParse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?, out sbyte)"/>
        /// means a <see cref="FormatException"/> can be thrown in any of those error condtions when it returns <c>false</c>.
        /// </summary>
        ...
        /// <returns><c>true</c> if <paramref name="s"/> was converted successfully; otherwise, <c>false</c>.</returns>
        /// <remarks>
        /// The <see cref="TryParse(ReadOnlySpan{char}, out sbyte)"/> method is like the <see cref="Parse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?)"/> method,
        /// except the <see cref="TryParse(ReadOnlySpan{char}, out sbyte)"/> method does not throw an exception if the
        /// conversion fails. It eliminates the need to use exception handling to test for a <see cref="FormatException"/>
        /// in the event that <paramref name="s"/> is invalid and cannot be successfully parsed.
        /// <para/>
        /// The <paramref name="s"/> parameter contains a number of the form:
        ...
        /// In addition to the decimal digits, only leading and trailing spaces together with a leading sign are
        /// allowed. To explicitly define the style elements together with the culture-specific formatting
        /// information that can be present in <paramref name="s"/>, use the <see cref="TryParse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?, out sbyte)"/> method.
        /// <para/>
        /// The <paramref name="s"/> parameter is parsed using the formatting information in a <see cref="NumberFormatInfo"/>
        /// object initialized for the current system culture. For more information, see <see cref="NumberFormatInfo.CurrentInfo"/>.
        /// <para/>
        /// This overload of the <see cref="TryParse(ReadOnlySpan{char}, out sbyte)"/> method interprets all digits in the <paramref name="s"/> parameter
        /// as decimal digits. To parse the string representation of a hexadecimal number, call the
        /// <see cref="TryParse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?, out sbyte)"/> overload.
        /// </remarks>
        ...
        ///         number in exponential notation, it must represent an integer within the range of the <see cref="sbyte"/> data type
        ...
        /// object for the current culture is used.
        /// </remarks>
        /// <seealso cref="TryParse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?, out sbyte)"/>
        public static sbyte Parse(ReadOnlySpan<char> s, NumberStyle style, IFormatProvider? provider) // J2N: Renamed from ParseByte()
        {
            NumberStyleExtensions.ValidateParseStyleInteger(style);
            DotNetNumber.ParsingStatus status = DotNetNumber.TryParseInt32(s, style, NumberFormatInfo.GetInstance(provider), out int i);
            if (status != DotNetNumber.ParsingStatus.OK)
        ...
        #region TryParse_CharSequence_NumberStyle_IFormatProvider_SByte
        ...
        /// </exception>
        /// <remarks>
        /// The <see cref="TryParse(string?, NumberStyle, IFormatProvider?, out sbyte)"/> method is like the <see cref="Parse(string, NumberStyle, IFormatProvider?)"/> method,
        /// except the <see cref="TryParse(string?, NumberStyle, IFormatProvider?, out sbyte)"/> method does not throw an exception if the
        /// conversion fails. It eliminates the need to use exception handling to test for a <see cref="FormatException"/>
        /// in the event that <paramref name="s"/> is invalid and cannot be successfully parsed.
        /// <para/>
        ...
        public static bool TryParse([NotNullWhen(true)] string? s, NumberStyle style, IFormatProvider? provider, out sbyte result)
        {
            NumberStyleExtensions.ValidateParseStyleInteger(style);
            if (s == null)
            {
        ...
        /// </exception>
        /// <remarks>
        /// The <see cref="TryParse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?, out sbyte)"/> method is like the <see cref="Parse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?)"/> method,
        /// except the <see cref="TryParse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?, out sbyte)"/> method does not throw an exception if the
        /// conversion fails. It eliminates the need to use exception handling to test for a <see cref="FormatException"/>
        /// in the event that <paramref name="s"/> is invalid and cannot be successfully parsed.
        /// <para/>
        /// The <paramref name="style"/> parameter defines the style elements (such as white space or a positive or negative sign)
        ...
        /// </remarks>
        /// <seealso cref="Parse(ReadOnlySpan{char}, NumberStyle, IFormatProvider?)"/>
        /// <seealso cref="TryParse(ReadOnlySpan{char}, out sbyte)"/>
        /// <seealso cref="Number.ToString()"/>
        /// <seealso cref="NumberStyle"/>
        public static bool TryParse(ReadOnlySpan<char> s, NumberStyle style, IFormatProvider? provider, out sbyte result)
        {
            NumberStyleExtensions.ValidateParseStyleInteger(style);
        ...
        /// <summary>
        /// Converts the value of the current <see cref="SByte"/> object to its equivalent string representation.
        /// </summary>
        ...
        ///         <term><see cref="ToString(sbyte, IFormatProvider?)"/> or <see cref="ToString(IFormatProvider?)"/></term>
        ///     </item>
        ///     <item>
        ///         <term>A specific format or precision</term>
        ///         <term>Default (current) culture</term>
        ///         <term><see cref="ToString(sbyte, string?)"/> or <see cref="ToString(string?)"/></term>
        ///     </item>
        ///     <item>
        ///         <term>A specific format or precision</term>
        ///         <term>A specific culture</term>
        ///         <term><see cref="ToString(sbyte, string?, IFormatProvider?)"/> or <see cref="ToString(string?, IFormatProvider?)"/></term>
        ///     </item>
        /// </list>
        /// <para/>
        ...
        /// <returns>The string representation of the current <see cref="SByte"/> object, formatted as specified by
        ...
        ///         <term>Default ("J") format</term>
        ///         <term>Default (current) culture</term>
        ///         <term><see cref="ToString(sbyte)"/> or <see cref="ToString()"/></term>
        ///     </item>
        ///     <item>
        ///         <term>Default ("J") format</term>
        ///         <term>A specific culture</term>
        ...
        /// <summary>
        /// Converts the numeric value of the current <see cref="SByte"/> object to its equivalent string representation using the
        ...
        /// <summary>
        /// Converts the value of the current <see cref="SByte"/> object to its equivalent string representation using the specified format
        /// and culture-specific formatting information.
        /// </summary>
        /// <param name="format">A standard or custom numeric format string.</param>
        /// <param name="provider">An object that supplies culture-specific formatting information.</param>
        /// <returns>The string representation of the current <see cref="SByte"/> object, formatted as specified by the <paramref name="format"/>
        ...
        /// </list>
        /// <para/>
        /// The <see cref="ToString(string?, IFormatProvider?)"/> method formats a <see cref="SByte"/> value in a specified format
        ...
        /// The <see cref="ToString()"/> method formats the current instance in the default ("J", or Java)
        /// format of the current culture. If you want to specify a different format, precision, or culture, use the
        /// other overloads of the <see cref="ToString(sbyte, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ///         <term>To use format</term>
        ///         <term>For culture</term>
        ...
        /// </exception>
        /// <remarks>
        /// The <see cref="ToString(sbyte, string?)"/> method formats the current instance in
        /// a specified format by using the conventions of the current culture. If you want to specify a different format or culture,
        /// use the other overloads of the <see cref="ToString(sbyte, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ///         <term>To use format</term>
        ///         <term>For culture</term>
        ...
        /// The return value of this function is formatted using the <see cref="NumberFormatInfo"/> object for the thread current culture.
        /// For information about the thread current culture, see <see cref="System.Threading.Thread.CurrentCulture"/>. To provide formatting information
        /// for cultures other than the current culture, call the <see cref="ToString(sbyte, string?, IFormatProvider?)"/> method.
        /// <para/>
        /// .NET provides extensive formatting support, which is described in greater detail in the following formatting topics:
        /// <list type="bullet">
        ///     <item><description>For more information about numeric format specifiers, see
        ...
        /// <remarks>
        /// The <see cref="ToString(sbyte, IFormatProvider?)"/> method formats the current instance in
        /// the default ("J") format of a specified culture. If you want to specify a different format or culture, use the
        /// other overloads of the <see cref="ToString(sbyte, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ...
        /// in the Remarks section.</exception>
        /// <remarks>
        /// The <see cref="ToString(sbyte, string?, IFormatProvider?)"/> method formats the current instance in
        /// a specified format of a specified culture. If you want to specify a different format or culture, use the
        /// other overloads of the <see cref="ToString(sbyte, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ...
        /// </list>
        /// <para/>
        /// The <see cref="ToString(sbyte, string?, IFormatProvider?)"/> method formats a <see cref="sbyte"/> value in a specified format
        /// of a specified culture. To format a number by using the default ("J") format of the current culture, call the
        /// <see cref="ToString(sbyte)"/> method. To format a number by using a specified format of the current culture, call the
        /// <see cref="ToString(sbyte, string?)"/> method.
        /// <para/>
        /// The <paramref name="format"/> parameter can be either a standard or a custom numeric format string. All standard
        /// numeric format strings other than "R" (or "r") are supported, as are all custom numeric format characters. If
        /// <paramref name="format"/> is <c>null</c> or an empty string (""), the return value of this method is formatted
        ...
        /// <param name="provider">An object that supplies culture-specific information about the format of <paramref name="s"/>. If provider is <c>null</c>,
        /// the thread current culture is used.</param>
        /// <returns>An immutable <see cref="SByte"/> instance that is equivalent to the number contained in <paramref name="s"/>.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="s"/> is <c>null</c>.</exception>
        /// <exception cref="FormatException"><paramref name="s"/> is not of the correct format.</exception>
        /// <exception cref="OverflowException">
        /// <paramref name="s"/> represents a number less than <see cref="sbyte.MinValue"/> or <see cref="sbyte.MaxValue"/>.
        ...
        /// Parses the <see cref="string"/> argument as a <see cref="SByte"/> in the specified <paramref name="radix"/>. 
        /// <para/>
        /// Usage Note: The conversion operation is similar to the <see cref="Convert.ToSByte(string?, int)"/> method. It differs in that
        /// it allows the use of the ASCII character \u002d ('-') or \u002B ('+') in any <paramref name="radix"/>.
        /// <para/>
        /// Supports any BMP (Basic Multilingual Plane) or SMP (Supplementary Mulitlingual Plane) digit as defined by Unicode 10.0.
        /// <para/>
        ...
        /// <param name="radix">The radix (or base) to use when parsing <paramref name="s"/>. The value must be in the range
        /// <see cref="Character.MinRadix"/> - <see cref="Character.MaxRadix"/> inclusive.</param>
        /// <returns>An immutable <see cref="SByte"/> instance that is equivalent to the number in <paramref name="s"/>, or 0 (zero) if
        /// <paramref name="s"/> is <c>null</c>.</returns>
        /// <remarks>
        /// If <paramref name="radix"/> is 16, you can prefix the number specified by the <paramref name="s"/> parameter with "0x" or "0X".
        /// <para/>
        ...
        /// <summary>
        /// Returns an immutable <see cref="SByte"/> instance for the specified <paramref name="value"/>.
        /// <para/>
        /// Usage Note: This is the same operation as Byte.valueOf() in the JDK.
        /// </summary>
        /// <param name="value">The <see cref="sbyte"/> value the returned instance represents.</param>
        /// <returns>An immutable <see cref="SByte"/> instance containing the <paramref name="value"/>,
        /// which may be retrieved from a cache.</returns>
        public static SByte GetInstance(sbyte value)
        {
            lock (Cache)
            {
                int idx = value - sbyte.MinValue;
                SByte result = Cache[idx];
                return result ?? (Cache[idx] = new SByte(value));
            }
        }
        ...
        /// <inheritdoc/>
        public static implicit operator SByte(sbyte value) => GetInstance(value);
        ...
        /// <summary>
        /// Returns the <see cref="TypeCode"/> for value type <see cref="sbyte"/>.
        /// </summary>
        /// <returns>The enumerated constant, <see cref="TypeCode.SByte"/>.</returns>
        ...
        {
            throw new InvalidCastException(J2N.SR.Format(SR.InvalidCast_FromTo, "SByte", "DateTime"));
        }
