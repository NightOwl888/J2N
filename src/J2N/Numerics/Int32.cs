...
namespace J2N.Numerics
{
    ...
    public sealed class Int32 : Number, IComparable<Int32>, IComparable, IConvertible, IEquatable<Int32>
    {
        ...
        public static Int32 Decode(string s)
        {
            ...
            int r = ParseNumbers.StringToInt(s.AsSpan(), @base, flags: ParseNumbers.IsTight, sign, ref i, s.Length - i);
        ...
        public static bool TryDecode(string s, [MaybeNullWhen(false)] out Int32 result)
        {
            ...
            if (!ParseNumbers.TryStringToInt(s.AsSpan(), @base, flags: ParseNumbers.IsTight, sign, ref i, s.Length - i, out int r) ||
                // Only allow negative if it was passed as a sign in the string
                (r < 0 && sign > 0))
            {
                return false;
        ...
        internal static int ParseUnsigned(string s, int startIndex, int length, int radix) // For testing purposes (actual method will eventually go on the UInt64 type when it is created)
        {
            ...
            return ParseNumbers.StringToInt(s.AsSpan(), radix, flags: ParseNumbers.IsTight | ParseNumbers.TreatAsUnsigned, sign: 1, ref startIndex, length);
        }
        ...
        public static int Parse(string s, int startIndex, int length, int radix) // KEEP OVERLOADS FOR ICharSequence, char[], ReadOnlySpan<char>, StringBuilder, and string IN SYNC
        {
            ...
            return ParseNumbers.StringToInt(s.AsSpan(), radix, flags: ParseNumbers.IsTight, sign: 1, ref startIndex, length);
        }
        ...
        public static int Parse(ICharSequence s, int startIndex, int length, int radix) // KEEP OVERLOADS FOR ICharSequence, char[], ReadOnlySpan<char>, StringBuilder, and string IN SYNC
        {
            ...
            {
                return ParseNumbers.StringToInt(stringBuilderCharSequence.Value!, radix, flags: ParseNumbers.IsTight, sign: 1, ref startIndex, length);
            }
            if (s is StringBuffer stringBuffer)
            {
                lock (stringBuffer.SyncRoot)
                {
                    return ParseNumbers.StringToInt(stringBuffer.builder, radix, flags: ParseNumbers.IsTight, sign: 1, ref startIndex, length);
                }
            }
        ...
        public static bool TryParse(string s, int startIndex, int length, int radix, out int result) // KEEP OVERLOADS FOR ICharSequence, char[], ReadOnlySpan<char>, StringBuilder, and string IN SYNC
        {
            ...
            return ParseNumbers.TryStringToInt(s.AsSpan(), radix, flags: ParseNumbers.IsTight, sign: 1, ref startIndex, length, out result);
        }
        ...
        public static bool TryParse(ICharSequence s, int startIndex, int length, int radix, out int result) // KEEP OVERLOADS FOR ICharSequence, char[], ReadOnlySpan<char>, StringBuilder, and string IN SYNC
        {
            ...
            if (s is StringBuilderCharSequence stringBuilderCharSequence)
            {
                return ParseNumbers.TryStringToInt(stringBuilderCharSequence.Value!, radix, flags: ParseNumbers.IsTight, sign: 1, ref startIndex, length, out result);
            }
            if (s is StringBuffer stringBuffer)
            {
                lock (stringBuffer.SyncRoot)
                {
                    return ParseNumbers.TryStringToInt(stringBuffer.builder, radix, flags: ParseNumbers.IsTight, sign: 1, ref startIndex, length, out result);
                }
            }
        ...
        public static bool TryParse(string? s, int radix, out int result) // J2N: Renamed from ParseInt()
        {
            ...
            return ParseNumbers.TryStringToInt(s.AsSpan(), radix, ParseNumbers.IsTight, out result);
        }
        ...
        public static bool TryParse([NotNullWhen(true)] string? s, out int result)
        {
            ...
            return DotNetNumber.TryParseInt32IntegerStyle(s.AsSpan(), NumberStyle.Integer, NumberFormatInfo.CurrentInfo, out result) == DotNetNumber.ParsingStatus.OK;
        }
        ...
        public static bool TryParse([NotNullWhen(true)] string? s, NumberStyle style, IFormatProvider? provider, out int result)
        {
            ...
            return DotNetNumber.TryParseInt32(s.AsSpan(), style, NumberFormatInfo.GetInstance(provider), out result) == DotNetNumber.ParsingStatus.OK;
        }
        ...
        /// <summary>
        /// Converts the value of the current <see cref="Int32"/> object to its equivalent string representation.
        /// </summary>
        ...
        ///         <term><see cref="ToString(int, IFormatProvider?)"/> or <see cref="ToString(IFormatProvider?)"/></term>
        ///     </item>
        ///     <item>
        ///         <term>A specific format or precision</term>
        ///         <term>Default (current) culture</term>
        ///         <term><see cref="ToString(int, string?)"/> or <see cref="ToString(string?)"/></term>
        ///     </item>
        ///     <item>
        ///         <term>A specific format or precision</term>
        ///         <term>A specific culture</term>
        ///         <term><see cref="ToString(int, string?, IFormatProvider?)"/> or <see cref="ToString(string?, IFormatProvider?)"/></term>
        ///     </item>
        /// </list>
        /// <para/>
        ...
        /// <returns>The string representation of the current <see cref="Int32"/> object, formatted as specified by
        ...
        ///         <term>Default ("J") format</term>
        ///         <term>Default (current) culture</term>
        ///         <term><see cref="ToString(int)"/> or <see cref="ToString()"/></term>
        ///     </item>
        ///     <item>
        ///         <term>Default ("J") format</term>
        ///         <term>A specific culture</term>
        ...
        /// <summary>
        /// Converts the numeric value of the current <see cref="Int32"/> object to its equivalent string representation using the
        ...
        /// <summary>
        /// Converts the value of the current <see cref="Int32"/> object to its equivalent string representation using the specified format
        /// and culture-specific formatting information.
        /// </summary>
        /// <param name="format">A standard or custom numeric format string.</param>
        /// <param name="provider">An object that supplies culture-specific formatting information.</param>
        /// <returns>The string representation of the current <see cref="Int32"/> object, formatted as specified by the <paramref name="format"/>
        ...
        /// </list>
        /// <para/>
        /// The <see cref="ToString(string?, IFormatProvider?)"/> method formats a <see cref="Int32"/> value in a specified format
        ...
        /// The <see cref="ToString()"/> method formats the current instance in the default ("J", or Java)
        /// format of the current culture. If you want to specify a different format, precision, or culture, use the
        /// other overloads of the <see cref="ToString(int, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ///         <term>To use format</term>
        ///         <term>For culture</term>
        ...
        /// </exception>
        /// <remarks>
        /// The <see cref="ToString(int, string?)"/> method formats the current instance in
        /// a specified format by using the conventions of the current culture. If you want to specify a different format or culture,
        /// use the other overloads of the <see cref="ToString(int, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ///         <term>To use format</term>
        ///         <term>For culture</term>
        ...
        /// The return value of this function is formatted using the <see cref="NumberFormatInfo"/> object for the thread current culture.
        /// For information about the thread current culture, see <see cref="System.Threading.Thread.CurrentCulture"/>. To provide formatting information
        /// for cultures other than the current culture, call the <see cref="ToString(int, string?, IFormatProvider?)"/> method.
        /// <para/>
        /// .NET provides extensive formatting support, which is described in greater detail in the following formatting topics:
        /// <list type="bullet">
        ///     <item><description>For more information about numeric format specifiers, see
        ...
        /// <remarks>
        /// The <see cref="ToString(int, IFormatProvider?)"/> method formats the current instance in
        /// the default ("J") format of a specified culture. If you want to specify a different format or culture, use the
        /// other overloads of the <see cref="ToString(int, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ...
        /// in the Remarks section.</exception>
        /// <remarks>
        /// The <see cref="ToString(int, string?, IFormatProvider?)"/> method formats the current instance in
        /// a specified format of a specified culture. If you want to specify a different format or culture, use the
        /// other overloads of the <see cref="ToString(int, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ...
        /// </list>
        /// <para/>
        /// The <see cref="ToString(int, string?, IFormatProvider?)"/> method formats a <see cref="int"/> value in a specified format
        /// of a specified culture. To format a number by using the default ("J") format of the current culture, call the
        /// <see cref="ToString(int)"/> method. To format a number by using a specified format of the current culture, call the
        /// <see cref="ToString(int, string?)"/> method.
        /// <para/>
        /// The <paramref name="format"/> parameter can be either a standard or a custom numeric format string. All standard
        /// numeric format strings other than "R" (or "r") are supported, as are all custom numeric format characters. If
        /// <paramref name="format"/> is <c>null</c> or an empty string (""), the return value of this method is formatted
        ...
        /// <param name="s">A string containing a number to convert.</param>
        /// <param name="provider">An <see cref="IFormatProvider"/> that supplies culture-specific formatting information about <paramref name="s"/>.</param>
        /// <returns>An immutable <see cref="Int32"/> instance equivalent to the number specified in <paramref name="s"/>.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="s"/> is <c>null</c>.</exception>
        /// <exception cref="FormatException"><paramref name="s"/> is not in a valid <see cref="NumberStyle.Integer"/> format.</exception>
        /// <exception cref="OverflowException">
        /// <paramref name="s"/> represents a number less than <see cref="int.MinValue"/> or greater than <see cref="int.MaxValue"/>.
        ...
        /// <summary>
        /// Parses the <see cref="string"/> argument as a signed <see cref="Int32"/> instance in the specified <paramref name="radix"/>. 
        /// <para/>
        /// Usage Note: This method is similar to the <see cref="Convert.ToInt64(string?, int)"/> method. It differs in that
        /// it allows the use of the ASCII character \u002d ('-') or \u002B ('+') in any <paramref name="radix"/>.
        /// <para/>
        ...
        /// <param name="radix">The radix (or base) to use when parsing <paramref name="s"/>. The value must be in the range
        /// <see cref="Character.MinRadix"/> - <see cref="Character.MaxRadix"/> inclusive.</param>
        /// <returns>An immutable <see cref="Int32"/> instance that is equivalent to the number in <paramref name="s"/>, or 0 (zero) if
        /// <paramref name="s"/> is <c>null</c>.</returns>
        /// <remarks>
        /// If <paramref name="radix"/> is 16, you can prefix the number specified by the <paramref name="s"/> parameter with "0x" or "0X".
        /// <para/>
        ...
        /// <summary>
        /// Returns an immutable <see cref="Int32"/> instance for the specified <paramref name="value"/>.
        /// <para/>
        /// Usage Note: This is the same operation as Integer.valueOf() in the JDK.
        /// </summary>
        /// <param name="value">The <see cref="int"/> value the returned instance represents.</param>
        /// <returns>An immutable <see cref="Int32"/> instance containing the <paramref name="value"/>,
        ...
        {
            /// <summary>
            /// A cache of instances used by <see cref="GetInstance(int)"/> and auto-boxing.
            /// </summary>
        ...
        /// <inheritdoc/>
        public static implicit operator Int32(int value) => GetInstance(value);
