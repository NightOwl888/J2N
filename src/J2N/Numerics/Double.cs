...
namespace J2N.Numerics
{
    ...
    /// <para/>
    /// In addition, this class provides methods for converting a <see cref="double"/> to a <see cref="string"/> and
    /// a <see cref="string"/> to a <see cref="double"/> that are compatible with Java. These methods provide better performance
    ...
    /// <para/>
    /// Instances of this class can be produced implicitly by setting a <see cref="double"/> value to a variable declared
    /// as <see cref="Double"/>
    /// <code>
    /// double value = 4.4d;
    /// Double instance = value;
    /// </code>
    /// Or explicitly by calling one of the <see cref="GetInstance(double)"/> methods.
    /// <para/>
    /// The <see cref="double"/> value of a <see cref="Double"/> can also be retrieved in several ways. For implicit
    /// conversion, simply assign a <see cref="double"/> variable an instance of <see cref="Double"/>.
    /// <code>
    /// Double instance = Double.GetInstance(4.4d);
    /// double value = instance;
    /// </code>
    /// To explicitly get the value, call <see cref="ToDouble()"/> or use the <see cref="Convert"/> class.
    /// <code>
    ...
    public sealed class Double : Number, IComparable<Double>, IComparable, IConvertible, IEquatable<Double>
    {
        ...
        ///         <term><see cref="ToString(double, IFormatProvider?)"/> or <see cref="ToString(IFormatProvider?)"/></term>
        ///     </item>
        ///     <item>
        ///         <term>A specific format or precision</term>
        ///         <term>Default (current) culture</term>
        ///         <term><see cref="ToString(double, string?)"/> or <see cref="ToString(string?)"/></term>
        ///     </item>
        ///     <item>
        ///         <term>A specific format or precision</term>
        ///         <term>A specific culture</term>
        ///         <term><see cref="ToString(double, string?, IFormatProvider?)"/> or <see cref="ToString(string?, IFormatProvider?)"/></term>
        ///     </item>
        /// </list>
        ...
        {
            return DotNetNumber.FormatDouble(value, null, null);
        }
        ...
        ///         <term>Default ("J") format</term>
        ///         <term>Default (current) culture</term>
        ///         <term><see cref="ToString(double)"/> or <see cref="ToString()"/></term>
        ///     </item>
        ///     <item>
        ///         <term>Default ("J") format</term>
        ///         <term>A specific culture</term>
        ...
        /// format can only be round-tripped using overloads of <see cref="Parse(string, IFormatProvider?)"/> and <see cref="TryParse(string?, out double)"/>
        /// in J2N. On .NET Core 3.0 and higher overloads of <see cref="double.Parse(string)"/> and <see cref="double.TryParse(string, out double)"/> will
        ...
        {
            return DotNetNumber.FormatDouble(value, format, null);
        }
        ...
        {
            return DotNetNumber.FormatDouble(value, null, provider);
        }
        ...
        /// <remarks>
        /// The <see cref="ToString(double)"/> method formats <paramref name="value"/> in the default ("J", or Java)
        /// format of the current culture. If you want to specify a different format, precision, or culture, use the
        /// other overloads of the <see cref="ToString(double, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ///         <term>To use format</term>
        ///         <term>For culture</term>
        ...
        /// <remarks>
        /// The <see cref="ToString(double, string?)"/> method formats <paramref name="value"/> in
        /// a specified format by using the conventions of the current culture. If you want to specify a different format or culture,
        /// use the other overloads of the <see cref="ToString(double, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ///         <term>To use format</term>
        ///         <term>For culture</term>
        ...
        /// <remarks>
        /// The <see cref="ToString(double, IFormatProvider?)"/> method formats <paramref name="value"/> in
        /// the default ("J") format of a specified culture. If you want to specify a different format or culture, use the
        /// other overloads of the <see cref="ToString(double, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ...
        /// and <paramref name="provider"/>.</returns>
        /// <remarks>
        /// The <see cref="ToString(double, string?, IFormatProvider?)"/> method formats <paramref name="value"/> in
        /// a specified format of a specified culture. If you want to specify a different format or culture, use the
        /// other overloads of the <see cref="ToString(double, string?, IFormatProvider?)"/> method, as follows:
        /// <list type="table">
        ///     <listheader>
        ...
        /// <summary>
        /// Converts the string representation of a number in a specified style and culture-specific format to
        /// its <see cref="Double"/> instance equivalent.
        /// <para/>
        /// Usage Note: To approximately match the behavior of the JDK for decimal numbers, use <see cref="NumberStyle.Float"/> combined with
        /// <see cref="NumberStyle.AllowTypeSpecifier"/> for <c>style</c> and <see cref="NumberFormatInfo.InvariantInfo"/> for <paramref name="provider"/>.
        /// To approximately match the behavior of the JDK for hexadecimal numbers, use <see cref="NumberStyle.HexFloat"/> combined with
        ...
        /// <param name="s">A string that contains a number to convert.</param>
        /// <param name="provider">An object that supplies culture-specific formatting information about <paramref name="s"/>.</param>
        /// <returns>An immutable <see cref="Double"/> instance equivalent to the numeric value or symbol specified in <paramref name="s"/>.</returns>
        /// <exception cref="ArgumentNullException"><paramref name="s"/> is <c>null</c>.</exception>
        /// <exception cref="FormatException"><paramref name="s"/> does not represent a number in a valid format.</exception>
        /// <remarks>
        /// In .NET Core 3.0 and later, values that are too large to represent are rounded to <see cref="double.PositiveInfinity"/> or
        ...
        /// <summary>
        /// Returns an immutable <see cref="Double"/> instance for the specified <paramref name="value"/>.
        /// <para/>
        /// Usage Note: This is the same operation as Double.valueOf() in the JDK.
        /// </summary>
        /// <param name="value">The <see cref="double"/> value the returned instance represents.</param>
        /// <returns>An immutable <see cref="Double"/> instance containing the <paramref name="value"/>.</returns>
