...
namespace J2N.Numerics
{
    internal static partial class DotNetNumber
    {
        ...
        internal unsafe ref struct BigInteger
        {
            ...
            {
                return 32 - (uint)BitOperation.LeadingZeroCount((int)value);
            }

            public static uint CountSignificantBits(ulong value)
            {
                return 64 - (uint)BitOperation.LeadingZeroCount((long)value);
            }
            ...
            public static void DivRem(ref BigInteger lhs, ref BigInteger rhs, out BigInteger quo, out BigInteger rem)
            {
                ...
                if (rhsLength == 1)
                {
                    ...
                    for (int i = quoLength - 1; i >= 0; i--)
                    {
                        ...
                        ulong digit = MathExtensions.DivRem(value, rhsValue, out carry);
                ...
                else
                {
                    ...
                    int shiftLeft = BitOperation.LeadingZeroCount((int)divHi);
...
#pragma warning restore CS9080 // Use of variable in this context may expose referenced variables outside of their declaration scope
            ...
            public static void Multiply(ref BigInteger lhs, ref BigInteger rhs, out BigInteger result)
            {
                ...
                result.ZeroMemory((uint)maxResultLength);
            ...
            public static void Pow2(uint exponent, out BigInteger result)
            {
                ...
                if (blocksToShift > 0)
                {
                    ...
                    result.ZeroMemory(blocksToShift);
                }
...
#pragma warning restore CS9080, CS9091, CS9094
            ...
            private void ZeroMemory(uint length)
            {
