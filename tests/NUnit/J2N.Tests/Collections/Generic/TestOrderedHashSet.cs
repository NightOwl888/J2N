...
{
    public class TestOrderedHashSet : TestCase
    {
        OrderedHashSet<object> hs;
        ...
        /**
         * @tests java.util.OrderedHashSet#OrderedHashSet()
         */
        [Test]
        public void Test_Constructor()
        {
            // Test for method java.util.OrderedHashSet()
            OrderedHashSet<object> hs2 = new OrderedHashSet<object>();
            assertEquals("Created incorrect OrderedHashSet", 0, hs2.Count);
        }

        /**
         * @tests java.util.OrderedHashSet#OrderedHashSet(int)
         */
        [Test]
        public void Test_ConstructorI()
        {
            // Test for method java.util.OrderedHashSet(int)
            OrderedHashSet<object> hs2 = new OrderedHashSet<object>(5);
            assertEquals("Created incorrect OrderedHashSet", 0, hs2.Count);
            try
            {
                new OrderedHashSet<object>(-1);
            }
        ...
        /////**
        //// * @tests java.util.OrderedHashSet#OrderedHashSet(int, float)
        //// */[Test]
        ////public void Test_ConstructorIF()
        ////{
        ////    // Test for method java.util.OrderedHashSet(int, float)
        ////    OrderedHashSet<object> hs2 = new OrderedHashSet<object>(5/*, (float)0.5*/)
        ////    assertEquals("Created incorrect OrderedHashSet", 0, hs2.size());
        ////    try
        ////    {
        ////        new OrderedHashSet<object>(0, 0);
        ////    }
        ////    catch (ArgumentException e)
        ////    {
        ////        return;
        ...
        /**
         * @tests java.util.OrderedHashSet#OrderedHashSet(java.util.Collection)
         */
        [Test]
        public void Test_ConstructorLjava_util_Collection()
        {
            // Test for method java.util.OrderedHashSet(java.util.Collection)
            OrderedHashSet<object> hs2 = new OrderedHashSet<object>(objArray);
            for (int counter = 0; counter < objArray.Length; counter++)
                assertTrue("OrderedHashSet does not contain correct elements", hs
                        .Contains(objArray[counter]));
            assertTrue("OrderedHashSet created from collection incorrect size", hs2
                    .Count == objArray.Length);
        }

        /**
         * @tests java.util.OrderedHashSet#add(java.lang.Object)
         */
        [Test]
        public void Test_addLjava_lang_Object()
        {
            // Test for method boolean java.util.OrderedHashSet.add(java.lang.Object)
            int size = hs.Count;
            hs.Add(new int?(8));
        ...
        /**
         * @tests java.util.OrderedHashSet#clear()
         */
        [Test]
        public void Test_clear()
        {
            // Test for method void java.util.OrderedHashSet.clear()
            var orgSet = new OrderedHashSet<object>(hs, EqualityComparer<object>.Default);
            hs.Clear();
        ...
        /**
         * @tests java.util.OrderedHashSet#clone()
         */
        [Test]
        public void Test_clone()
        {
            // Test for method java.lang.Object java.util.OrderedHashSet.clone()
            var hs2 = new OrderedHashSet<object>(hs, EqualityComparer<object>.Default);
            assertTrue("clone returned an equivalent OrderedHashSet", hs != hs2);
            assertTrue("clone did not return an equal OrderedHashSet", hs
                    .Equals(hs2));
        }

        /**
         * @tests java.util.OrderedHashSet#contains(java.lang.Object)
         */
        [Test]
        public void Test_containsLjava_lang_Object()
        {
            // Test for method boolean
            // java.util.OrderedHashSet.contains(java.lang.Object)
            assertTrue("Returned false for valid object", hs.Contains(objArray[90]));
            assertTrue("Returned true for invalid Object", !hs
                    .Contains(new Object()));

            OrderedHashSet<object> s = new OrderedHashSet<object>();
            s.Add(null);
            assertTrue("Cannot handle null", s.Contains(null));
        }

        /**
         * @tests java.util.OrderedHashSet#isEmpty()
         */
        [Test]
        public void Test_isEmpty()
        {
            // Test for method boolean java.util.OrderedHashSet.isEmpty()
            assertTrue("Empty set returned false", !(new OrderedHashSet<object>().Any()));
            assertTrue("Non-empty set returned true", hs.Any());
        }

        /**
         * @tests java.util.OrderedHashSet#iterator()
         */
        [Test]
        public void Test_iterator()
        {
            // Test for method java.util.Iterator java.util.OrderedHashSet.iterator()
        ...
        /**
         * @tests java.util.OrderedHashSet#remove(java.lang.Object)
         */
        [Test]
        public void Test_removeLjava_lang_Object()
        {
            // Test for method boolean
            // java.util.OrderedHashSet.remove(java.lang.Object)
            int size = hs.Count;
            ...
            var s = new OrderedHashSet<object>();
            s.Add(null);
            assertTrue("Cannot handle null", s.Remove(null));
        }

        /**
         * @tests java.util.OrderedHashSet#size()
         */
        [Test]
        public void Test_size()
        {
            // Test for method int java.util.OrderedHashSet.size()
        ...
        {
            var set = new OrderedHashSet<string>(StringComparer.Ordinal);
            set.Add("one");
            set.Add("two");
            set.Add("three");
        ...
        {
            hs = new OrderedHashSet<object>(EqualityComparer<object>.Default);
            for (int i = 0; i < objArray.Length; i++)
                hs.Add(objArray[i]);
            hs.Add(null);
        }
        ...
        public class JDK7Basic : TestCase
        {
            ...
            public void TestBasic()
            {
                ...
                {
                    ISet<int> s1 = new OrderedHashSet<int>();
                    AddRandoms(s1, setSize);

                    ISet<int> s2 = new OrderedHashSet<int>();
                    ...
                    assertEquals("Incorrect hashCode computation.", new OrderedHashSet<int>(union).GetHashCode(), union.GetHashCode());
            ...
            static ISet<int> clone(ISet<int> s)
            {
                ...
                clone = //(method==0 ?  (ISet<int>) ((OrderedHashSet<int>)s).clone() :
                    new OrderedHashSet<int>(s, EqualityComparer<int>.Default);
