...
namespace J2N.Text
{
    ...
    /// </summary>
    public partial class TestSynchronizedTextBuilder : TestCase
    {
        /**
        ...
        public void Test_setLengthI()
        {
            ...
            SynchronizedTextBuilder buffer = new SynchronizedTextBuilder("abcde");
            try
            {
                buffer.Length = (-1);
            ...
            buffer = new SynchronizedTextBuilder("abcde");
            ...
            buffer = new SynchronizedTextBuilder();
        ...
        {
            SynchronizedTextBuilder buffer = new SynchronizedTextBuilder();
        ...
        /**
         * @tests SynchronizedTextBuilder.SynchronizedTextBuilder(CharSequence);
         */
        [Test]
        public void Test_Constructor_ICharSequence()
        {
            //try
            //{
            //    new SynchronizedTextBuilder((ICharSequence)null);
            //    fail("Assert 0: NPE must be thrown.");
            //}
            //catch (ArgumentNullException e) { }

            assertEquals(string.Empty, new SynchronizedTextBuilder((ICharSequence)null).ToString()); // J2N: To match .NET, a null in the constructor should return string.Empty

            assertEquals("Assert 1: must equal 'abc'.", "abc", new SynchronizedTextBuilder((ICharSequence)"abc".AsCharSequence()).ToString());
        }
        ...
        public void Test_Constructor_CharArray()
        {
            ...
            assertEquals(string.Empty, new SynchronizedTextBuilder((char[])null).ToString()); // J2N: To match .NET, a null in the constructor should return string.Empty

            assertEquals("Assert 1: must equal 'abc'.", "abc", new SynchronizedTextBuilder((char[])"abc".ToCharArray()).ToString());
        }
        ...
        public void Test_Constructor_StringBuilder()
        {
            ...
            assertEquals(string.Empty, new SynchronizedTextBuilder((StringBuilder)null).ToString()); // J2N: To match .NET, a null in the constructor should return string.Empty

            assertEquals("Assert 1: must equal 'abc'.", "abc", new SynchronizedTextBuilder((StringBuilder)new StringBuilder("abc")).ToString());
        }
        ...
        public void Test_Constructor_String()
        {
            ...
            assertEquals(string.Empty, new SynchronizedTextBuilder((string)null).ToString()); // J2N: To match .NET, a null in the constructor should return string.Empty
        ...
        /**
         * @tests java.lang.SynchronizedTextBuilder.Append(CharSequence, int, int)
         */
        [Test]
        ...
        {
            SynchronizedTextBuilder obj = new SynchronizedTextBuilder();
            try
            {
        ...
        /**
         * @tests java.lang.SynchronizedTextBuilder.insert(int, CharSequence)
         */
        [Test]
        public void Test_Insert_Int32_ICharSequence()
        {
            ...
            sb = new SynchronizedTextBuilder(fixture);
        ...
        /**
         * @tests java.lang.SynchronizedTextBuilder.insert(int, CharSequence, int, int)
         */
        [Test]
        ...
        /**
         * @tests java.lang.SynchronizedTextBuilder.appendCodePoint(int)'
         */
        [Test]
        ...
        /**
         * @tests java.lang.SynchronizedTextBuilder.codePointAt(int)
         */
        [Test]
        public void Test_codePointAtI()
        {
            SynchronizedTextBuilder sb = new SynchronizedTextBuilder("abc");
            assertEquals('a', sb.CodePointAt(0));
            assertEquals('b', sb.CodePointAt(1));
            assertEquals('c', sb.CodePointAt(2));

            sb = new SynchronizedTextBuilder("\uD800\uDC00");
        ...
        /**
         * @tests java.lang.SynchronizedTextBuilder.codePointBefore(int)
         */
        [Test]
        ...
        /**
         * @tests java.lang.SynchronizedTextBuilder.codePointCount(int, int)
         */
        [Test]
        public void Test_codePointCountII()
        {
            assertEquals(1, new SynchronizedTextBuilder("\uD800\uDC00").CodePointCount(0, 2 - 0)); // J2N: Corrected length parameter
            assertEquals(1, new SynchronizedTextBuilder("\uD800\uDC01").CodePointCount(0, 2 - 0)); // J2N: Corrected length parameter
            assertEquals(1, new SynchronizedTextBuilder("\uD801\uDC01").CodePointCount(0, 2 - 0)); // J2N: Corrected length parameter
            assertEquals(1, new SynchronizedTextBuilder("\uDBFF\uDFFF").CodePointCount(0, 2 - 0)); // J2N: Corrected length parameter

            assertEquals(3, new SynchronizedTextBuilder("a\uD800\uDC00b").CodePointCount(0, 4 - 0)); // J2N: Corrected length parameter
            assertEquals(4, new SynchronizedTextBuilder("a\uD800\uDC00b\uD800").CodePointCount(0, 5 - 0)); // J2N: Corrected length parameter
        ...
        /**
         * @tests java.lang.SynchronizedTextBuilder.offsetByCodePoints(int, int)'
         */
        [Test]
        public void Test_offsetByCodePointsII()
        {
            int result = new SynchronizedTextBuilder("a\uD800\uDC00b").OffsetByCodePoints(0, 2);
            assertEquals(3, result);

            result = new SynchronizedTextBuilder("abcd").OffsetByCodePoints(3, -1);
            assertEquals(2, result);

            result = new SynchronizedTextBuilder("a\uD800\uDC00b").OffsetByCodePoints(0, 3);
            assertEquals(4, result);

            result = new SynchronizedTextBuilder("a\uD800\uDC00b").OffsetByCodePoints(3, -1);
            assertEquals(1, result);

            result = new SynchronizedTextBuilder("a\uD800\uDC00b").OffsetByCodePoints(3, 0);
            assertEquals(3, result);

            result = new SynchronizedTextBuilder("\uD800\uDC00bc").OffsetByCodePoints(3, 0);
            assertEquals(3, result);

            result = new SynchronizedTextBuilder("a\uDC00bc").OffsetByCodePoints(3, -1);
            assertEquals(2, result);
        ...
        /**
         * @tests {@link java.lang.SynchronizedTextBuilder#indexOf(String, int)}
         */
        [Test]
        ...
        /**
         * @tests {@link java.lang.SynchronizedTextBuilder#lastIndexOf(String, int)}
         */
        [Test]
        ...
        //// comparator for SynchronizedTextBuilder objects
        ...
        //        SynchronizedTextBuilder init = (SynchronizedTextBuilder)initial;
        //        SynchronizedTextBuilder desr = (SynchronizedTextBuilder)deserialized;
...
//            //SerializationTest.verifySelf(new SynchronizedTextBuilder("0123456789"),
//            //            STRING_BUFFER_COMPARATOR);

//            var target = new SynchronizedTextBuilder("0123456789");
...
//#endif
        ...
        ////    SerializationTest.verifyGolden(this, new SynchronizedTextBuilder("0123456789"),
        ////                STRING_BUFFER_COMPARATOR);
        ////}
    }
}
