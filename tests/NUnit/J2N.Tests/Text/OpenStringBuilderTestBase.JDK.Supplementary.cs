...
namespace J2N.Text
{
    ...
    public abstract partial class OpenStringBuilderTestBase
    {
        ...
        public void Test_test1()
        {
            ...
            {
                OpenStringBuilder sb = OpenStringBuilderFactory(input[i]);
        ...
        public void Test_test3()
        {
            for (int i = 0; i < input.Length; i++)
            {
                OpenStringBuilder sb = OpenStringBuilderFactory(input[i]).Reverse();
            ...
            {
                OpenStringBuilder sb = OpenStringBuilderFactory(testdata1[i][0]).Reverse();
        ...
        public void Test_test4()
        {
            for (int i = 0; i < input.Length; i++)
            {
                ...
                {
                    c = s.CodePointAt(j);
                    OpenStringBuilder rsb = sb.AppendCodePoint(c);
        ...
        static void testCodePoint(bool isAt, OpenStringBuilder sb, int index, int expected)
        {
        ...
        static void testCodePoint(bool isAt, OpenStringBuilder sb, int index)
        {
            if (isAt)
            {
        ...
        static void testCodePointCount(OpenStringBuilder sb, int beginIndex, int endIndex,
        ...
        static void testOffsetByCodePoints(OpenStringBuilder sb, int index, int offset,
            Type expectedException)
        {
            Assert.Throws(expectedException, () =>
            {
        ...
        static void check(bool err, string s, OpenStringBuilder got, string expected)
        {
            if (err)
            {
                Assert.Fail("Error: " + s
