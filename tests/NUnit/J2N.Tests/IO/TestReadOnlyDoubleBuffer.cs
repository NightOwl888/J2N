...
namespace J2N.IO
{
    public class TestReadOnlyDoubleBuffer : TestDoubleBuffer
    {
        ...
        [Test]
        public override void TestPutdoubleArrayintint()
        {
            double[] array = new double[1];
            try
            {
        ...
        [Test]
        public override void TestPutDoubleBuffer()
        {
        ...
        [Test]
        public override void TestPutintdouble()
        {
            try
            {
                buf.Put(0, (double)0);
