...
namespace J2N.Collections.Tests
{
    ...
    public abstract class TestBase<T> : TestBase
    {
        ...
        /// </summary>
        protected virtual IEqualityComparer<T> GetIEqualityComparer() => J2N.Collections.Generic.EqualityComparer<T>.Default;

        /// <summary>
        /// The Comparer that can be used in the overriding class when creating test enumerables
        /// or test collections. Default if not overridden is the default comparator.
        /// </summary>
        protected virtual IComparer<T> GetIComparer() => J2N.Collections.Generic.Comparer<T>.Default;
