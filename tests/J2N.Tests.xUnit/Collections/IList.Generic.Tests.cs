...
namespace J2N.Collections.Tests
{
    ...
    public abstract class IList_Generic_Tests<T> : ICollection_Generic_Tests<T>
    {
        ...
        protected abstract SCG.IList<T> GenericIListFactory();
        ...
        /// <returns>An instance of an IList{T} that can be used for testing.</returns>
        protected virtual SCG.IList<T> GenericIListFactory(int count)
        {
            SCG.IList<T> collection = GenericIListFactory();
        ...
        protected override SCG.ICollection<T> GenericICollectionFactory() => GenericIListFactory();

        protected override SCG.ICollection<T> GenericICollectionFactory(int count) => GenericIListFactory(count);
