...
namespace J2N.Collections.Concurrent.Tests
{
    ...
    /// </summary>
    public abstract class LurchTable_Generic_Tests<TKey, TValue> : IDictionary_Generic_Tests<TKey, TValue>
    {
        ...
        /// </summary>
        protected override bool IDictionary_Generic_Keys_Values_ModifyingTheDictionaryUpdatesTheCollection => true;
        ...
        {
            return new LurchTable<TKey, TValue>();
        }
        ...
        public void Dictionary_Generic_Constructor_IDictionary(int count)
        {
            ...
            SCG.IDictionary<TKey, TValue> copied = new LurchTable<TKey, TValue>(source);
        ...
        {
            SCG.IDictionary<TKey, TValue> dictionary = new LurchTable<TKey, TValue>(count);
        ...
        //        {
        //            var dictionary = (LurchTable<TKey, TValue>)(GenericIDictionaryFactory(count));
        ...
        //        {
        //            var dictionary = new LurchTable<TKey, TValue>();
        ...
        //        {
        //            var dictionary = new LurchTable<TKey, TValue>(capacity);
        //            Assert.Equal(capacity, dictionary.EnsureCapacity(capacity));

        //            dictionary = (LurchTable<TKey, TValue>)GenericIDictionaryFactory(capacity);
        //            Assert.Equal(capacity, dictionary.EnsureCapacity(capacity));
        //        }
        ...
        //            dictionary = (LurchTable<TKey, TValue>)GenericIDictionaryFactory(count);
        ...
        //            dictionary = new LurchTable<TKey, TValue>();
        ...
        //            dictionary = new LurchTable<TKey, TValue>(suggestedCapacity);
        //            dictionary.Add(GetNewKey(dictionary), CreateTValue(0));
        //            AssertExtensions.Throws<ArgumentOutOfRangeException>("capacity", () => dictionary.TrimExcess(0));
        //        }
        ...
        //        {
        //            var dictionary = new LurchTable<TKey, TValue>(20);
        ...
        //            dictionary = new LurchTable<TKey, TValue>(suggestedCapacity / 2);
        ...
        //        {
        //            var dictionary = new LurchTable<int, int>(20);
        ...
        //            var dictionary = new LurchTable<int, int>(initialCount);
        ...
        //        {
        //            var dictionary = new LurchTable<string, int>(7);
        //            for (int i = 0; i < 4; i++)
        //            {
