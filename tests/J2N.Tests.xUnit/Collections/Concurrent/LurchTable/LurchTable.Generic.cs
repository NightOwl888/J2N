...
{
    public partial class LurchTable_Generic_Tests_string_string : LurchTable_Generic_Tests<string, string>
    {
    ...
    public class LurchTable_Generic_Tests_int_int : LurchTable_Generic_Tests<int, int>
    {
    ...
    public class LurchTable_Generic_Tests_SimpleInt_int_With_Comparer_WrapStructural_SimpleInt : LurchTable_Generic_Tests<SimpleInt, int>
    {
