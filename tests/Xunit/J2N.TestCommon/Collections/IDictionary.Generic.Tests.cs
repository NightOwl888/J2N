...
namespace J2N.Collections.Tests
{
    ...
    public abstract partial class IDictionary_Generic_Tests<TKey, TValue> : ICollection_Generic_Tests<KeyValuePair<TKey, TValue>>
    {
        ...
        {
            return J2N.Collections.Generic.EqualityComparer<TKey>.Default;
        }
        ...
        {
            return J2N.Collections.Generic.Comparer<TKey>.Default;
        }
        ...
        protected override bool DefaultValueAllowed => true; // J2N supports null dictionary keys
