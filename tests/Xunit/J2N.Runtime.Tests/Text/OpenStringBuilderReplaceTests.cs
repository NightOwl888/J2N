...
{
    public abstract class OpenStringBuilderReplaceTests
    {
        [Theory]
        [InlineData("", "a", "!", 0, 0, "")]
        ...
        //{
        //    OpenStringBuilder builder = OpenStringBuilderTests.StringBuilderWithMultipleChunks();
        ...
        protected abstract OpenStringBuilder Replace(OpenStringBuilder builder, string oldValue, string newValue);

        protected abstract OpenStringBuilder Replace(OpenStringBuilder builder, string oldValue, string newValue, int startIndex, int count);
    }

    public class OpenStringBuilderReplaceTests_String : OpenStringBuilderReplaceTests
    {
        [Fact]
        ...
        protected override OpenStringBuilder Replace(OpenStringBuilder builder, string oldValue, string newValue)
            => builder.Replace(oldValue, newValue);

        protected override OpenStringBuilder Replace(OpenStringBuilder builder, string oldValue, string newValue, int startIndex, int count)
            => builder.Replace(oldValue, newValue, startIndex, count);
    }

    public class OpenStringBuilderReplaceTests_Span : OpenStringBuilderReplaceTests
    {
        protected override OpenStringBuilder Replace(OpenStringBuilder builder, string oldValue, string newValue)
