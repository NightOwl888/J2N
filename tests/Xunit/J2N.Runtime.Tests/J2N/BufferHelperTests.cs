// Source: https://github.com/dotnet/runtime/blob/v9.0.1/src/libraries/System.Runtime/tests/System.Runtime.Tests/System/BufferTests.cs
...
namespace J2N.Tests
{
    public static class BufferHelperTests
    {
        //[Fact]
        ...
        public static unsafe void MemoryCopy(int sourceLength, int sourceIndexOffset, int destinationLength, int destinationIndexOffset, long sourceBytesToCopy)
        {
            ...
            {
                BufferHelper.MemoryCopy(sourceBase + sourceIndexOffset, destinationBase + destinationIndexOffset, destinationLength, sourceBytesToCopy);
            }
        ...
        public static unsafe void MemoryCopy_Invalid()
        {
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("sourceBytesToCopy", () =>
            {
                ...
                {
                    BufferHelper.MemoryCopy(sourceBase, destinationBase, 5000 * 4, 20000 * 4); // Source bytes to copy > destination size in bytes
                }
            });
            ...
            AssertExtensions.Throws<ArgumentOutOfRangeException>("sourceBytesToCopy", () =>
            {
                fixed (int* sourceBase = sourceArray, destinationBase = destinationArray)
                {
                    BufferHelper.MemoryCopy(sourceBase, destinationBase, (ulong)5000 * 4, (ulong)20000 * 4); // Source bytes to copy > destination size in bytes
                }
            });
        }
