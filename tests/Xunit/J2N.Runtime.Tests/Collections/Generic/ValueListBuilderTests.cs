// Source: https://github.com/dotnet/runtime/blob/v11.0.0-preview.6.26359.118/src/libraries/Common/tests/Tests/System/Collections/Generic/ValueListBuilderTests.cs
...
namespace J2N.Collections.Generic.Tests
{
    /// <summary>
    ...
    public class ValueListBuilderTests
    {
        ...
        public void Ctor_Default_CanAppend()
        {
            ...
            AssertExtensions.Equal("a".ToCharArray(), vsb.ToArrayAndDispose());
        }
        ...
        public void Append_Char_MatchesStringBuilder()
        {
            ...
            AssertExtensions.Equal(sb.ToCharArray(), vsb.ToArrayAndDispose());
        }
        ...
        public void ToString_ClearsBuilder_ThenReusable()
        {
            ...
            AssertExtensions.Equal(Text1.ToCharArray(), s);

            Assert.Equal(0, vsb.Length);
            AssertExtensions.Equal(string.Empty.ToCharArray(), vsb.ToArrayAndDispose());

            const string Text2 = "another test";
            vsb.Append(Text2);
            Assert.Equal(Text2.Length, vsb.Length);
            AssertExtensions.Equal(Text2.ToCharArray(), vsb.ToArrayAndDispose());
        }
        ...
        public void Dispose_ClearsBuilder_ThenReusable()
        {
            ...
            Assert.Equal(0, vsb.Length);
            AssertExtensions.Equal([], vsb.ToArrayAndDispose());
    ...
    internal static class ValueListBuilderExtensions
    {
        public static T[] ToArrayAndDispose<T>(this ref ValueListBuilder<T> builder)
        {
            T[] s = builder.AsSpan().ToArray();
            builder.Dispose();
            return s;
        }
    }
    ...
    internal static class StringBuilderExtensions
    {
        public static char[] ToCharArray(this StringBuilder builder)
        {
            ...
            builder.CopyTo(0, result, 0, builder.Length);
            return result;
        }
    }
}
