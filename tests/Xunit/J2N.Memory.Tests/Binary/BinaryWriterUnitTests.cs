// Source: https://github.com/dotnet/runtime/blob/v9.0.3/src/libraries/System.Memory/tests/Binary/BinaryWriterUnitTests.cs
...
using static J2N.Buffers.Binary.BinaryPrimitive;

#pragma warning disable CS9191 // The in parameter is equivalent to in

namespace J2N.Memory.Binary.Tests
{
    public class BinaryWriterUnitTests
    {
        ...
        public void SpanWrite()
        {
            ...
            //Half halfValue = BitConversion.Int16BitsToHalf(0x1122);
            ...
            float floatValue = BitConversion.Int32BitsToSingle(0x11223344);
            ...
            double doubleValue = BitConversion.Int64BitsToDouble(0x1122334455667788);
