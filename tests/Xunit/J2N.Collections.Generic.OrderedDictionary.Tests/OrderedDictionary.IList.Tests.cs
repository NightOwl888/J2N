...
namespace J2N.Collections.Tests
{
    public class OrderedDictionary_IList_Tests : IList_Generic_Tests<KeyValuePair<string, string>>
    {
        ...
        protected override IList<KeyValuePair<string, string>> GenericIListFactory() => new JCG.OrderedDictionary<string, string>();
        ...
        {
            var dictionary = new JCG.OrderedDictionary<string, string>()
            {
                ["a"] = "1",
                ["b"] = "2",
                ["c"] = "3"
    ...
    public class OrderedDictionary_IList_NonGeneric_Tests : IList_NonGeneric_Tests
    {
        ...
        protected override IList NonGenericIListFactory() => new JCG.OrderedDictionary<string, string>();
        ...
        {
            IList list = NonGenericIListFactory();
            list.Add(KeyValuePairHelpers.Create("key", "value"));
        ...
        {
            IList list = NonGenericIListFactory();
            list.Insert(0, KeyValuePairHelpers.Create("key", "value"));
    ...
    public class OrderedDictionary_Keys_IList_NonGeneric_Tests : IList_NonGeneric_Tests
    {
        ...
        protected override IList NonGenericIListFactory() => new JCG.OrderedDictionary<string, string>().Keys;
    ...
    public class OrderedDictionary_Values_IList_Generic_Tests : IList_Generic_Tests<string>
    {
        ...
        protected override IList<string> GenericIListFactory() => new JCG.OrderedDictionary<string, string>().Values;
    ...
    public class OrderedDictionary_Values_IList_NonGeneric_Tests : IList_NonGeneric_Tests
    {
        ...
        protected override IList NonGenericIListFactory() => new JCG.OrderedDictionary<string, string>().Values;
