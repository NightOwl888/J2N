...
namespace J2N.Collections.Tests
{
    ...
    public abstract partial class List_Generic_Tests<T> : IList_Generic_Tests<T>
    {
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("list", () => ListExtensions.InsertRange(null!, 0, ReadOnlySpan<int>.Empty));
            AssertExtensions.Throws<ArgumentNullException>("list", () => ListExtensions.InsertRange(null!, 0, new ReadOnlySpan<int>(new int[1])));

            var list = new List<int>();
            AssertExtensions.Throws<ArgumentOutOfRangeException>("index", () => ListExtensions.InsertRange(list, 1, new int[0]));
            AssertExtensions.Throws<ArgumentOutOfRangeException>("index", () => ListExtensions.InsertRange(list, -1, new int[0]));
        }
