...
namespace J2N.Collections.Tests
{
    ...
    public class List_Generic_Tests_Insert
    {
        ...
        {
            public Func<T[], SCG.IEnumerable<T>>[] CollectionGenerators { get; }

            public Driver()
            {
                CollectionGenerators = new Func<T[], SCG.IEnumerable<T>>[]
                {
                    ConstructTestList,
            ...
            public void InsertRangeIEnumerable(T[] itemsX, T[] itemsY, int index, int repeat, Func<T[], SCG.IEnumerable<T>> constructIEnumerable)
            {
            ...
            public void InsertRangeValidations(T[] items, Func<T[], SCG.IEnumerable<T>> constructIEnumerable)
            {
            ...
            public SCG.IEnumerable<T> ConstructTestEnumerable(T[] items)
            {
                return items;
            }

            public SCG.IEnumerable<T> ConstructLazyTestEnumerable(T[] items)
            {
                return ConstructTestEnumerable(items)
                    .Select(item => item);
            }

            public SCG.IEnumerable<T> ConstructTestList(T[] items)
            {
                return items.ToList();
            }
            ...
            public void NonGenericIListContainsTestParams()
            {
                ...
                Assert.False(_ilist.Contains(new SCG.LinkedListNode<string>("rah")),
        ...
        public static void InsertRangeTests()
        {
            ...
            foreach (Func<int[], SCG.IEnumerable<int>> collectionGenerator in IntDriver.CollectionGenerators)
            {
            ...
            foreach (Func<string[], SCG.IEnumerable<string>> collectionGenerator in StringDriver.CollectionGenerators)
            {
