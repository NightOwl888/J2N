// Source: https://github.com/dotnet/runtime/blob/v10.0.0-rc.2.25502.107/src/libraries/System.Collections/tests/Generic/Dictionary/HashCollisionScenarios/OutOfBoundsRegression.cs
...
namespace J2N.Collections.Tests
{
...
#endif
        protected override SCG.IEqualityComparer<string> GetComparer(Dictionary<string, string> collection) => collection.EqualityComparer;
    ...
    {
        protected override Dictionary<string, string> CreateCollection() => new Dictionary<string, string>(StringComparer.Ordinal);
        protected override void AddKey(Dictionary<string, string> collection, string key) => CollectionMarshal.GetValueRefOrAddDefault<string, string>(collection, key, out _) = null;
        protected override bool ContainsKey(Dictionary<string, string> collection, string key) => collection.ContainsKey(key);
#if FEATURE_IALTERNATEEQUALITYCOMPARER
        protected override bool ContainsKey(Dictionary<string, string> collection, ReadOnlySpan<char> key) =>
            collection.GetAlternateLookup<ReadOnlySpan<char>>().ContainsKey(key);
...
#endif
        protected override SCG.IEqualityComparer<string> GetComparer(HashSet<string> collection) => collection.EqualityComparer;
    ...
    public abstract class InternalHashCodeTests<TCollection>
    {
        ...
        protected static Type nonRandomizedOrdinalComparerType = typeof(J2N.Character).Assembly.GetType("J2N.Collections.Generic.NonRandomizedStringEqualityComparer+OrdinalComparer", throwOnError: true);
        protected static Type nonRandomizedOrdinalIgnoreCaseComparerType = typeof(J2N.Character).Assembly.GetType("J2N.Collections.Generic.NonRandomizedStringEqualityComparer+OrdinalIgnoreCaseComparer", throwOnError: true);
        protected static Type randomizedOrdinalComparerType = typeof(J2N.Character).Assembly.GetType("J2N.Collections.Generic.RandomizedStringEqualityComparer+OrdinalComparer", throwOnError: true);
        protected static Type randomizedOrdinalIgnoreCaseComparerType = typeof(J2N.Character).Assembly.GetType("J2N.Collections.Generic.RandomizedStringEqualityComparer+OrdinalIgnoreCaseComparer", throwOnError: true);

        protected static Type cultureAwareComparerType = typeof(J2N.Character).Assembly.GetType("J2N.Collections.Generic.NonRandomizedStringEqualityComparer+CultureAwareComparer", throwOnError: true);
        ...
        protected abstract SCG.IEqualityComparer<string> ExpectedPublicComparerBeforeCollisionThreshold { get; }
        ...
        public void ComparerImplementations_Dictionary_WithWellKnownStringComparers()
        {
            ...
            SCG.IEqualityComparer<string> actualInternalComparerBeforeCollisionThreshold = (SCG.IEqualityComparer<string>)internalComparerField.GetValue(collection);
            ...
            SCG.IEqualityComparer<string> actualInternalComparerAfterCollisionThreshold = (SCG.IEqualityComparer<string>)internalComparerField.GetValue(collection);
            ...
            if (collection is ISerializable)
            {
                ...
                object serializedComparer = si.GetValue("EqualityComparer", typeof(SCG.IEqualityComparer<string>));
        ...
        private static List<string> GenerateCollidingStrings(int count)
        {
            ...
            static string GenerateCollidingStringCandidate(int seed)
            {
                ...
                return string.Create(8, seed, (span, seed) =>
                {
                    ...
                    uint hash2 = BitOperation.RotateLeft(hash1, 5) + hash1;

                    MemoryMarshal.Write(asBytes, in seed);
                    MemoryMarshal.Write(asBytes.Slice(4), in hash2); // set hash2 := 0 (for Ordinal)

                    hash1 = (BitOperation.RotateLeft(hash1, 5) + hash1) ^ (uint)seed;
                    hash1 = (BitOperation.RotateLeft(hash1, 5) + hash1);
        ...
        {
            MethodInfo method = typeof(J2N.Character).Assembly.GetType("J2N.StringHelper").GetMethod(
                methodName,
        ...
        private static void ValidateBehaviorOfInternalComparerVsPublicComparer(SCG.IEqualityComparer<string> internalComparer, SCG.IEqualityComparer<string> publicComparer)
        {
