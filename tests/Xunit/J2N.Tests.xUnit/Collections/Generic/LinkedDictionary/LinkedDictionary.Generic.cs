...
{
    public partial class LinkedDictionary_Generic_Tests_string_string : LinkedDictionary_Generic_Tests<string, string>
    {
    ...
    public class LinkedDictionary_Generic_Tests_int_int : LinkedDictionary_Generic_Tests<int, int>
    {
    ...
    public class LinkedDictionary_Generic_Tests_SimpleInt_int_With_Comparer_WrapStructural_SimpleInt : LinkedDictionary_Generic_Tests<SimpleInt, int>
    {
