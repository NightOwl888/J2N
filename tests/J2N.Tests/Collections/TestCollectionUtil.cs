// J2N: Missing HashMap<K, V> - not yet ported
...
//            Assert.AreEqual(setExpected, CollectionUtil.ToString(set));
...
//            Assert.AreEqual(mapExpectedPortuguese, CollectionUtil.ToString(map, new CultureInfo("pt")));
//            Assert.AreEqual(mapExpectedUSEnglish, CollectionUtil.ToString(map, new CultureInfo("en-US")));
...
//            Assert.AreEqual(arrayExpected, CollectionUtil.ToString(array));
//        }
