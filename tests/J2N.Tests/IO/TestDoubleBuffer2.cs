...
{
    /// <summary>
    /// Tests from JDK/nio/BasicDouble.java
    /// </summary>
    public class TestDoubleBuffer2 : BaseBufferTestCase
    {
        ...
        private static void tryCatch(double[] t, Type ex, Action thunk)
        {
        ...
        public static void test(double[] ba)
        {
            int offset = 47;
            int length = 900;
            DoubleBuffer b = DoubleBuffer.Wrap(ba, offset, length);
            Show(0, b);
