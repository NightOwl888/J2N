...
namespace Microsoft.VisualStudio.TestPlatform.ObjectModel
{
    ...
    {
        private const string UnexpectedTypeOfProperty = "The test property type '{0}' of property '{1}' is not supported. Use one of the supported property type (primitive types, uri, string, string[]) and try again. ";
        private const string Exception_RegisteredTestPropertyHasDifferentValueType = "Cannot register property '{0}' as value type '{1}' because it was already registered as '{2}'.";
        ...
        private TestProperty(string id, string label, string category, string description, Type valueType, ValidateValueCallback validateValueCallback, TestPropertyAttributes attributes)
        {
            ...
            {
                throw new ArgumentException(string.Format(CultureInfo.CurrentCulture, UnexpectedTypeOfProperty, valueType, id));
            }
                ...
                if (s_properties.TryGetValue(id, out propertyTypePair))
                {
                    ...
                    else
                    {
                        ...
                        string message = string.Format(
                            ...
                            Exception_RegisteredTestPropertyHasDifferentValueType,
                            id,
                            valueType.ToString(),
