...
namespace Microsoft.VisualStudio.TestPlatform.ObjectModel
{
    ...
    {
        private const string BasicTestResultFormat = "{0,-10}  {1}";
        private const string TestFailureMessageFormat = "  Message: {0}";
        private const string TestFailureStackTraceFormat = "  StackTrace:{0}{1}";
        private const string TestResultTextMessagesFormat = "  Test Messages:{0}{1}";
        private const string TestResultMessageFormat = "  {1}:{0}{2}";
        ...
        public override string ToString()
        {
            ...
            if (this.Outcome == TestOutcome.Failed)
            {
                // Add Error message.
                result.AppendLine();
                result.AppendFormat(CultureInfo.CurrentUICulture, TestFailureMessageFormat, this.ErrorMessage);
    ...
    /// </summary>
    [System.Diagnostics.CodeAnalysis.SuppressMessage("CodeQuality", "IDE0079:Remove unnecessary suppression", Justification = "CA2104 doesn't fire on all target frameworks")]
